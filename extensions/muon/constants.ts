...
export const MUON_CINDEX_SKILL_DIR = join(MUON_PACKAGE_ROOT_DIR, "skills", "cindex");
export const MUON_IPYNB_TOOLS_SHED_SKILL_DIR = join(MUON_PACKAGE_ROOT_DIR, "skills", "ipynb_toolshed");
export const MUON_HANDOFF_SKILL_DIR = join(MUON_PACKAGE_ROOT_DIR, "extensions", "handoff", "skills", "handoff");
