...
export const MUON_ENGINEERING_PROMPT_PATH = join(MUON_MODES_DIR, "engineering-prompt.md");
export const MUON_FOUNDATION_PROMPT_PATH = join(MUON_MODES_DIR, "foundation-prompt.md");
...
export const MUON_ENGINEERING_SKILLS_DIR = join(MUON_SKILLSETS_DIR, "engineering");
export const MUON_FOUNDATION_SKILLS_DIR = join(MUON_SKILLSETS_DIR, "foundation");
