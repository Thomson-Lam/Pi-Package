...
import registerTlogs from "./skillsets/standalone/tlogs/extension.js";
import registerTcmd from "./skillsets/standalone/tcmd/extension.js";
...
export default async function muonExtension(pi: ExtensionAPI): Promise<void> {
  ...
  registerTlogs(pi, () => state.config.enabledSkills.includes("tlogs"));
  registerTcmd(pi, () => state.config.enabledSkills.includes("tcmd"));
